<template>
  <transition name="list-fade">
    <div class="playlist" v-show="showFlog" @click="hide">
  ...
  export default {
    ...
    methods: {
      show () {
        this.showFlog = true
        setTimeout(() => {
          this.$refs.listContent.refresh()  // scroll 重新刷新
      ...
      selectItem (item, index) {
        ...
        this.setPlayingState(true)  // 修改播放状态为true
      },
      // 让scroll滚动到当前的歌曲
    ...
    watch: {
      currentSong (newSong, oldSong) {
        // 如果组件不显示，或者id没变化，则不操作
        if (!this.showFlog || newSong.id === oldSong.id) {
          return
        }
